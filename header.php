                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseSession" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="addSession.php">Add Session</a>
                                    <a class="nav-link" href="listAllSession.php">List all Session</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseStudent" aria-labelledby="headingFour" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="listAllStudent.php">List all Student</a>
                                </nav>
                            </div>
