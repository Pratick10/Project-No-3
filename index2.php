                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseSession" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Add Session</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">List all Session</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseSection" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Add Section</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">List all Section</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseSubject" aria-labelledby="headingThree" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Add Subjects</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">List all Subject</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseStudent" aria-labelledby="headingFour" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">Add Student</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">List all Student</a>
                                </nav>
                            </div>
