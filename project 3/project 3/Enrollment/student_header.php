...
<html lang="en">
    <head>
        ...
        <title>Dashboard - SB Student</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseSession" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="requestCourse.php">Request New Course</a>
                                    <a class="nav-link" href="viewCourse.php">View Requested course</a>
                                </nav>
                            </div>
